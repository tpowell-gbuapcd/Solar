...
def plot_solar_data(data, sol_curr, sys_curr, batt_size, sys_volt, max_dd, file_name):
    ...
    max_discharge_line = np.full(len(data['t_arr']), max_dd)
...
if __name__ == "__main__":
    ...
    parser.add_argument('-dd', '--max_discharge_depth', type=float, help='The maximum discharge depth of your battery. Ex) 0.50. Default assumes LiFePO4 battery, which is generally 2A.', default=2.0)
